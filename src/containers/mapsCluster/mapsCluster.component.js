...
const points = randomPoint(2000, { bbox }).features;
points.forEach((point, index) => {
    if (index == 0) console.log("soy miguel y soy puto") 
    point.id = index
});
...
class MapsCluster extends React.PureComponent {
  constructor(props) {
    super(props);
...
//             latitude: {props.match.params.lat}
//             longitude: {props.match.params.lng}
//             {/* cajeros : {result.data.cajeros.length} */}
//         </>
//     )
// }
